...
export function AlertModal() {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, background: 'rgba(28,27,26,.62)', zIndex: 120, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 26 }}>
      <div style={{ width: '100%', maxWidth: 440, background: 'var(--card)', border: '1px solid var(--terra)', borderRadius: 14, padding: 28, animation: 'fadeUp .14s ease', boxShadow: '0 24px 60px rgba(28,27,26,.3)' }}>
